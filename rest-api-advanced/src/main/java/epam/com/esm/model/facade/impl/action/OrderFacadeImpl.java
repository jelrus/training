...
public class OrderFacadeImpl implements OrderFacade {
     ...
     * @param dto requested object, holds requested values for order
     * @param id requested parameter value, holds order id value
     * @return {@code OrderUserDtoResponse} updated order
     */
    @Override
    public OrderUserDtoResponse update(OrderDtoRequest dto, Long id) {
        Order order = orderService.update(orderDtoVerifier.verifyUpdate(dto, orderService.findById(id)));
        return toDto(order, true);
    }
