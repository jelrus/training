...
public class TagDtoVerifier {
    ...
    private void checkDtoCollection(TagDtoRequest dto) {
        ...
        if (dto.getGiftCertificates().size() > new HashSet<>(dto.getGiftCertificates()).size()) {
            throw new InputException("Gift certificates contains duplicates");
        }
    }
}