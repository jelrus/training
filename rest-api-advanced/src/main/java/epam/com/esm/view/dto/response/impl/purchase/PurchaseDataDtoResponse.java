...
public class PurchaseDataDtoResponse extends DtoResponse {
    ...
    public PurchaseDataDtoResponse(PurchaseData purchaseData, boolean fold) {
        ...
        if (!fold) {
            setGiftCertificateDtoResponse(new GiftCertificateDtoResponse(purchaseData.getGiftCertificate()));
        }
    }
     ...
     */
    public GiftCertificateDtoResponse getGiftCertificateDtoResponse() {
     ...
     */
    public void setGiftCertificateDtoResponse(GiftCertificateDtoResponse giftCertificateDtoResponse) {
